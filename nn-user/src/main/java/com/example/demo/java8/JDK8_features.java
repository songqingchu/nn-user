...
public class JDK8_features {
	public List<Integer> list = (List<Integer>) Arrays.asList(1, 2, 3, 4, 5, 6, 7, 8, 9);
	...
	public void testStream() {
		List<Integer> nums = (List<Integer>) Arrays.asList(1, 1, null, 2, 3, 4, null, 5, 6, 7, 8, 9);
	...
	public void testParallel() {
		...
		// 1.给数组随机赋值
		Arrays.parallelSetAll(arrayOfLong, index -> ThreadLocalRandom.current().nextInt(0));
		// 2.打印出前个元素
	...
	/**
	 * .JVM的PermGen空间被移除：取代它的是Metaspace（JEP ）元空间
	 */
	@Test
